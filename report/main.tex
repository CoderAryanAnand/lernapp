...
Laut  \parencite{Lerntechnik_1} besteht der Unterschied daraus, dass Lernmethoden die allgemeine Lernstrategie beschreiben, während eine Lerntechnik eine einzelne spezifische Technik ist.
...
% ------------------------------Programmieren------------------------------
\chapter{Methodik \textendash\space Programmieren der Web-Applikation}
...
Im Falle, dass ein Nutzer zum Beispiel mit einer E-Mail, die schon gebraucht wird, sich registrieren will, oder mit einem falschen Passwort sich anmelden will, bekommt der Nutzer eine Fehlermeldung angezeigt, die ihm sagt, was falsch gelaufen ist, mithilfe von Flash-Nachrichten \parencite{realpython_flask_flashes}.
