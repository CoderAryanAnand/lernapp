...
\begin{figure}[!htp]
    \centering
    \includegraphics[width=0.9\textwidth]{img/graphs/Graph_WieFrühLernenInsgesamt.png}
    \includegraphics[width=0.3\textwidth]{img/graphs/Graph_WieFrühLernen1Gym.png}
    \includegraphics[width=0.3\textwidth]{img/graphs/Graph_WieFrühLernen2Gym.png}
    \includegraphics[width=0.3\textwidth]{img/graphs/Graph_WieFrühLernen3Gym.png}
...
\begin{figure}[!htp]
    \centering
    \includegraphics[width=0.9\textwidth]{img/graphs/img_Gründe1.png}
...
Tatsächlich gaben rund \textbf{57\%} aller Schüler:innen (Vgl. Abbildung \ref{graph-stressI}) an, dass sie oftmals Stress empfinden, und dieser Prozentsatz steigt in höheren Stufen und ist nie geringer als \textbf{50\%}.

\begin{figure}[!htp]
    \centering
    \includegraphics[width=0.9\textwidth]{img/graphs/Graph_SchülerStressINS.png}
    \includegraphics[width=0.3\textwidth]{img/graphs/Graph_SchülerStress1Gym.png}
    \includegraphics[width=0.3\textwidth]{img/graphs/Graph_SchülerStress2Gym.png}
    \includegraphics[width=0.3\textwidth]{img/graphs/Graph_SchülerStress3Gym.png}
...
\begin{figure}[!htp]
    \centering
    \includegraphics[width=0.9\textwidth]{img/graphs/Gründe_Stress.png}
...
\subsection{Homescreen / Dashboard}
...
Wichtig: Der Homescreen ist auch für nicht angemeldete Besucher:innen verfügbar. In diesem öffentlichen Modus wird eine gekürzte Ansicht präsentiert, die prominente Aufrufe zum Anmelden oder Registrieren enthält. Der tägliche Tipp wird gezeigt, aber alle User-spezifischen Daten (Noten, Termine, Prüfungen) sind ausgeblendet.

\myparagraph{Aufbau} Das Dashboard ist in mehrere Kacheln (Cards) in einem Grid-Layout gegliedert, die die folgenden Informationen anzeigen:

\begin{itemize} 
    \item \textbf{Notenübersicht:} Diese Kachel zeigt eine Zusammenfassung der akademischen Leistung aus dem neuesten Semester (aktueller Schnitt, Pluspunkte, wie auch das beste und schwächste Fach). Falls noch keine Noten eingetragen sind, wird ein Aufruf zur Eingabe von Noten angezeigt.
    ...
    \item \textbf{Nächste Prüfungen:} Zeigt eine Liste der anstehenden Prüfungen innerhalb der nächsten 21 Tage. Wenn die Prüfung innerhalb sieben Tage ist, wird sie hervorgehoben indem ihr Text rot dargestellt wird. Die späteren Prüfungen sind orange dargestellt.
    \item \textbf{Tip of the Day:} Ein Bereich mit täglich wechselnden, kurzen Hinweisen -- dieser Bereich ist sowohl für eingeloggte als auch für nicht eingeloggte Nutzer:innen sichtbar. Diese Funktion ist unten ausführlicher beschrieben.
...
Eine Kernanforderung unserer App ist die tägliche Bereitstellung eines neuen Tipps auf der Startseite, entweder über die Kantonsschule oder allgemeine Lerntipps. Die einfachste Möglichkeit, dies zu implementieren, ist eine simple Modulo-Rechnung:
\begin{equation*}
