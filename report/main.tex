...
\usepackage{fontspec} % Use fontspec for better font shape support
\setmainfont{Latin Modern Roman} % Set the main font explicitly
...
Unser Ziel mit den Interviews war es damit, möglichst vieles an nützlichen Informationen zu diesen Themenbereichen und geplanten Features für unsere Web-Applikation zu lernen.
...
Dabei achteten wir uns vor allem auch auf das Umfrage-Layout und die Art der Fragen, welche wir in der Umfrage einbauten, da unser Ziel war, eine möglichst zugängliche und, für die Befragten, möglichst unkomplizierte Umfrage zu erstellen.
...
Wir haben uns zwei PPP-Lehrpersonen der Kantonsschule Baden ausgesucht, nämlich Herr Schmocker und Frau Suter, von welchen wir auch durch unseren Erstbewerter Theoriedokumente zum Umfrage- und Interviewdesign erhalten haben\parencite{umfrageDesign}.
...
Empfohlene Tipps sind beispielsweise:
\begin{itemize}
...
Hier fliessen die Erkenntnisse der Literaturstudie und der Interviews hinein, damit wir unsere gewählten Themenbereiche möglichst genau abdecken können.
...
Somit wird an einem bestimmten Tag nur einen Tipp gezeigt und über das ganze Jahr sollten alle Tipps in einem Zyklus gezeigt werden (da wir sowieso weniger als 365 Tipps haben). Am ersten Tag wird der zweite Tipp der Liste gezeigt, da natürlich der Index bei 0 anfängt, aber der Tag des Jahres bei 1 anfängt. Es macht jedoch keinen Unterschied, ob der erste Tipp am ersten Tag oder der zweite Tipp am ersten Tag gezeigt wird, da es ja nur darum geht, dass jeden Tag ein anderer Tipp gezeigt wird.
