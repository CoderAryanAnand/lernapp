...
\JournalEntry[true]{Berichtserweiterungen/Tests und Code-Anpassungen}{Ca. 12.5h (Aryan: 5h, Simon: 7.5h)}{Aryan: Ich habe weitere Tests eingefügt, die man noch machen muss. Zudem habe ich noch den schriftlichen Kommentar ein bisschen poliert. Am Code gab es ein paar unvollständige Sachen mit den default Farben, die ich noch anpassen musste. Simon: Hauptsächlich weitere Arbeit am Bericht, Ergänzungen des Arbeitsjournals}{Aryan: Bericht ist schöner, es hat mehr Tests, und die default Farben der Erreignisse sind jetzt auch noch veränderbar (und in der Dokumentation begründet). Simon: Ich habe hauptsächlich an meinem Segment des Berichts gearbeitet, d.h. weiterhin die Recherche ergänzt. Ich konnte die Interviews grösstenteils fertigstellen.}{Aryan: Die Arbeit an den Tests und der Code-Anpassungen verlief gut. Simon: Ich konnte meine Schreibblockade von gestern umgehen und einigermassen zügig an meinem Text arbeiten. Jetzt bleibt nicht mehr so viel übrig}{\gitcommit{93d4a97011a9d3edd5fe7972654dd2c767cdfeaa}}
