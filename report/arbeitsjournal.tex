...
\JournalEntry[true]{Serverhosting}{Ca. 2h (Aryan)}{Hosting auf Railway.app eingerichtet. Mit KI habe ich herausgefunden, welche Serveroptionen es gibt.}{Die Web-Applikation läuft nun auf Railway.app.}{Die Einrichtung des Hostings verlief gut, obwohl es einige Herausforderungen gab. Ausserdem werden SMTP Mails geblockt von Railway, also muss ich dazu noch eine Lösung finden.}
