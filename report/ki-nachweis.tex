...
\addcontentsline{toc}{section}{Quellenverzeichnis KI}
...
\begin{itemize}
    ...
    \item \textbf{ChatGPT (Model 4.1)}: «ensure that the user must enter a grade in the rang 1-6», 09.10.2025. Antwort ganz übernommen.
    
    \item \textbf{ChatGPT (Model 4.1)}: «design a nice semester rename popup», 09.10.2025. Antwort als Basis.
    
    \item \textbf{ChatGPT (Model 4.1)}: «add a enter and escape keybind», 09.10.2025. Antwort ganz übernommen.
    
    \item \textbf{ChatGPT (Model 4.1)}: «how do i make rows draggable», 09.10.2025. Antwort als Basis.
    
    \item \textbf{ChatGPT (Model 4.1)}: «create a delete confirmation for events», 09.10.2025. Antwort als Basis.
    
    \item \textbf{ChatGPT (Model 4.1)}: «design the datenschutz page», 09.10.2025. Antwort als Basis.
\end{itemize}
